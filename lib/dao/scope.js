        ...
        targetModel.find(params, options, function (err, data) {
            ...
            if (scopeOnRelatedModel === true) {
                ...
                var buildWhere = function () {
                    ...
                    var mergedWhere = IdKeyCondition;
                    Object.keys(queryRelated.where).forEach(function(key) {
                        mergedWhere[key] = queryRelated.where[key];
                    });
